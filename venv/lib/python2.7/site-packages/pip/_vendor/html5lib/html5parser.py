...
def getPhases(debug):
    ...
    def getMetaclass(use_metaclass, metaclass_func):
        return method_decorator_metaclass(metaclass_func) if use_metaclass else type
    ...
    class InBodyPhase(Phase):
        ...
        def startTagA(self, token):
            if afeAElement := self.tree.elementInActiveFormattingElements("a"):
    ...
    class InForeignContentPhase(Phase):
        ...
        def processStartTag(self, token):
            ...
            if (
                token["name"] in self.breakoutElements
                or token["name"] == "font"
